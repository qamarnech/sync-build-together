...
export const Route = createFileRoute("/collaborate/partners")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Organisations contributing capabilities to the longevity ecosystem, with expertise, projects and collaboration interests." },
      { property: "og:title", content: "Partners — MR Longevity Collaborate" },
      { property: "og:description", content: "Universities, healthcare organisations, companies, manufacturers, investors and public bodies in the ecosystem." },
